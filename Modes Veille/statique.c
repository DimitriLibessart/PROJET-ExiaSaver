...
if(nombreAleatoire==4)
	...
	fichier = fopen("/home/Documents/EXIASAVER1_PBM/cubain.pbm", "r"); //si la valeur obtenue aprés le choix aléatoire est égal à 4 , on ouvre le fichier "statique1.pbm" avec l'argument "r" qui demande de lire  
	}
if(nombreAleatoire==5)
	{	

	fichier = fopen("/home/Documents/EXIASAVER1_PBM/cubdeu.pbm", "r");//si la valeur obtenue aprés le choix aléatoire est égal à 5 , on ouvre le fichier "statique2.pbm" avec l'argument "r" qui demande de lire
	}
if(nombreAleatoire==6)
	{

	fichier = fopen("/home/Documents/EXIASAVER1_PBM/cubtroi.pbm", "r");//si la valeur obtenue aprés le choix aléatoire est égal à 6 , on ouvre le fichier "statique3.pbm" avec l'argument "r" qui demande de lire
	}
if(nombreAleatoire==7)
	{
	
	fichier = fopen("/home/Documents/EXIASAVER1_PBM/cubquatre.pbm", "r");
	}
if(nombreAleatoire==8)
	{

	fichier = fopen("/home/Documents/EXIASAVER1_PBM/cubcinq.pbm", "r");
	}
	do
	{
